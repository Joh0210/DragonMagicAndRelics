...
public class DragonUpgradeEvent extends PlayerEvent {
    ...
    public DragonUpgradeEvent(Player player, IFaction targetFaction){
        ...
        if ((chestOld.getItem() instanceof BoneArmorItem || chestOld.getItem() instanceof CouncilArmorItem || chestOld.getItem() instanceof DemonArmorItem || chestOld.getItem() instanceof FeyArmorItem || chestOld.getItem() instanceof DragonMageArmorItem) && ((ISetItem) chestOld.getItem()).isSetEquipped(player)){
    ...
    public void performUpgradeFromDMArmor(){
        ...
        if(chestOld.getItem() instanceof DragonMageArmorItem && chestOld.hasTag()){
    ...
    private void addUpgrade(ArmorUpgrade upgrade, int level){
        ...
        ((DragonMageArmorItem)itemStack.getItem()).addDragonMagicToItem(itemStack, upgrade, level, true);
    }
