...
public class RingOfPower extends DragonMageCurios{
    ...
    public void appendHoverText(ItemStack stack, Level world, List<Component> tooltip, TooltipFlag flag) {
        tooltip.add(new TranslatableComponent("tooltip.dmnr.ring_of_power.tooltip.one"));
        tooltip.add(new TranslatableComponent("tooltip.dmnr.ring_of_power.tooltip.two"));
