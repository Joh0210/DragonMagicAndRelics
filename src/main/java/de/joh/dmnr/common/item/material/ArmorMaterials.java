package de.joh.dmnr.common.item.material;
...
public enum ArmorMaterials implements ArmorMaterial {
    ...
    */
    ...
    RUNE_MATERIAL("runemage", 13, new int[]{1, 3, 4, 1}, 25, SoundEvents.ARMOR_EQUIP_GOLD, 0.0F, 0.0F, () -> Ingredient.of(Items.GOLD_INGOT)),
