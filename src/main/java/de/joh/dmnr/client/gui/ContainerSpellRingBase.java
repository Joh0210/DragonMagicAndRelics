...
public abstract class ContainerSpellRingBase extends HeldContainerBase {
    public ContainerSpellRingBase(MenuType<?> type, int i, Inventory playerInv, ItemInventoryBase basebag) {
        super(type, i, playerInv, basebag);
    }

    @Override
    protected void initializeSlots(Inventory playerInv) {
        this.addSlot(this.slot(this.inventory, 0, 104+24, 100));
        int slotIndex = 1;
