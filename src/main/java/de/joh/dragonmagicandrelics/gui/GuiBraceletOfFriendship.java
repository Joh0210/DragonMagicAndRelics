...
public class GuiBraceletOfFriendship extends GuiBagBase<ContainerBraceletOfFriendship>{
    public GuiBraceletOfFriendship(ContainerBraceletOfFriendship inventorySlotsIn, Inventory inv, Component comp) {
