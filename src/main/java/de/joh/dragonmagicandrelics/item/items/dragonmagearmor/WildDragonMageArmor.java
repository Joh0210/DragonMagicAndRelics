...
import de.joh.dragonmagicandrelics.gui.NamedWildDragonMageArmor;
 ...
 * @author Joh0210
 */
public class WildDragonMageArmor extends DragonMageArmor {
    public WildDragonMageArmor(EquipmentSlot pSlot) {
