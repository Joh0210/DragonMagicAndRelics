...
/**
 * Material of the Dragon Mage Armor
 */
public enum ArmorMaterials implements IArmorMaterial {
    ...
    */
    ...
    DRAGON_MAGE_ARMOR_MATERIAL("dragon_mage", 37, new int[]{3, 6, 8, 3}, 20, SoundEvents.ITEM_ARMOR_EQUIP_NETHERITE, 3.0F, 0.1F, () -> Ingredient.fromItems(Items.NETHERITE_INGOT));
    ...
    ArmorMaterials(String pName, int pDurabilityMultiplier, int[] pSlotProtections, int pEnchantmentValue, SoundEvent pSound, float pToughness, float pKnockbackResistance, Supplier<Ingredient> pRepairIngredient) {
        this.name = pName;
    ...
    @Override
    public int getDurability(EquipmentSlotType pSlot) {
        return HEALTH_PER_SLOT[pSlot.getIndex()] * this.durabilityMultiplier;
    }

    @Override
    public int getDamageReductionAmount(EquipmentSlotType pSlot) {
    ...
    public String getName() {
        return DragonMagicAndRelics.MOD_ID + ":" + this.name;
    }
