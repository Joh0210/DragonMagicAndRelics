...
public class ArmorUpgrade extends ForgeRegistryEntry<ArmorUpgrade> {
    public static ArmorUpgrade INSTANCE = new ArmorUpgrade(RLoc.create("armorupgrade/none"), 0);
     ...
     */
    public ArmorUpgrade(@NotNull ResourceLocation registryName, int maxUpgradeLevel){
